...
INSERT INTO employee (employee_id, email, ssn, name) VALUES (1, 'collin@gmail.com', '680-40-1262', 'Collin Zhen'), (2, 'nichoj@sbcglobal.net', '040-98-7647', 'Talhah Muir'), 
...
-- chef table inserts
INSERT INTO chef (chef_id, employee, name) VALUES (1, 1, 'Collin Zhen'),(2,2,'Talhah Muir'),(3,3,'Kymani Cervantes');
...
INSERT INTO registerListing(employee, owner) VALUE(1,1),(2,2),(3,3);
...
INSERT INTO account (account_id, employee, type, password, created, guest) VALUES (1,1,1,'asdf','2020-05-18',1),(2,2,2,'asdfasd23','2020-02-11',2),(3,3,3,'jasldkjf23','2019-09-01',3);
